...
exports.style = function (MapCSS) {
    'use strict';

    function restyle(style, tags, zoom, type, selector) {
        var s_roads_casing = {}, s_over6 = {}, s_over5 = {}, s_over4 = {}, s_over3 = {}, s_over2 = {}, s_over1 = {}, s_under1 = {}, s_under2 = {}, s_ele = {}, s_access = {}, s_everything = {}, s_bridge_casing2 = {}, s_oneway_over2 = {}, s_oneway_over3 = {}, s_bridge_casing1 = {}, s_oneway_over1 = {}, s_tram_under2 = {}, s_casing1 = {}, s_casing2 = {}, s_default = {}, s_water_lines_casing = {}, s_tram_under3 = {}, s_tram = {}, s_oneway = {};
        ...
        if ((type == 'way')) {
            s_everything['linejoin'] = 'miter';
            s_everything['linecap'] = 'none';
        }

        if (((selector == 'area' && true))) {
            s_default['fill-opacity'] = 1;
        }

        if ((selector == '*')) {
            s_everything['text-halo-color'] = 'white';
            s_everything['text-anchor-horizontal'] = 'center';
            s_everything['text-anchor-vertical'] = 'center';
        }
        ...
        if (((type == 'way' && tags['waterway'] == 'stream' && (!tags.hasOwnProperty('tunnel?'))) && zoom >= 13 && zoom <= 14) || ((type == 'way' && tags['waterway'] == 'ditch' && (!tags.hasOwnProperty('tunnel?'))) && zoom >= 13 && zoom <= 14) || ((type == 'way' && tags['waterway'] == 'drain' && (!tags.hasOwnProperty('tunnel?'))) && zoom >= 13 && zoom <= 14)) {
            s_water_lines_casing['color'] = 'white';
            s_water_lines_casing['width'] = 1.5;
            s_water_lines_casing['z-index'] = -1;
        }

        if (((type == 'way' && tags['waterway'] == 'stream' && (!tags.hasOwnProperty('tunnel?'))) && zoom >= 15)) {
            s_water_lines_casing['color'] = 'white';
            s_water_lines_casing['width'] = 2.5;
            s_water_lines_casing['z-index'] = -1;
        }
        ...
        if (((selector == 'area' && tags['highway'] == 'residential' && true) && zoom >= 14) || ((selector == 'area' && tags['highway'] == 'unclassified' && true) && zoom >= 14)) {
            s_default['color'] = '#999999';
            s_default['width'] = 1;
        }

        if (((selector == 'area' && tags['highway'] == 'pedestrian' && true) && zoom >= 14) || ((selector == 'area' && tags['highway'] == 'service' && true) && zoom >= 14) || ((selector == 'area' && tags['highway'] == 'footway' && true) && zoom >= 14) || ((selector == 'area' && tags['highway'] == 'path' && true) && zoom >= 14)) {
            s_default['color'] = 'grey';
            s_default['width'] = 1;
        }

        if (((selector == 'area' && tags['highway'] == 'track' && true) && zoom >= 14)) {
            s_default['color'] = '#996600';
            s_default['width'] = 2;
        }

        if (((selector == 'area' && tags['highway'] == 'platform' && true) && zoom >= 16) || ((selector == 'area' && tags['railway'] == 'platform' && true) && zoom >= 16)) {
            s_default['color'] = 'grey';
            s_default['linecap'] = 'round';
            s_default['linejoin'] = 'round';
            s_default['width'] = 2;
        ...
        if (((type == 'way' && tags['highway'] == 'raceway') && zoom === 12)) {
            s_roads_casing['color'] = 'pink';
            s_roads_casing['linejoin'] = 'round';
            s_roads_casing['width'] = 1.2;
            s_roads_casing['z-index'] = -1;
        }

        if (((type == 'way' && tags['highway'] == 'raceway') && zoom >= 13 && zoom <= 14)) {
            s_roads_casing['color'] = 'pink';
            s_roads_casing['linejoin'] = 'round';
            s_roads_casing['width'] = 4;
            s_roads_casing['z-index'] = -1;
        }
        ...
        if (((type == 'way' && tags['highway'] == 'raceway') && zoom >= 15)) {
            s_roads_casing['color'] = 'pink';
            s_roads_casing['linejoin'] = 'round';
            s_roads_casing['width'] = 7;
            s_roads_casing['z-index'] = -1;
        }

        if (((type == 'way' && tags['highway'] == 'motorway_link' && (!tags.hasOwnProperty('tunnel?'))) && zoom === 12)) {
            s_roads_casing['color'] = '#506077';
            s_roads_casing['linejoin'] = 'round';
            s_roads_casing['width'] = 1.5;
            s_roads_casing['z-index'] = -1;
        }
        ...
        if (((type == 'way' && tags['highway'] == 'motorway_link' && (!tags.hasOwnProperty('tunnel?'))) && zoom >= 17)) {
            s_roads_casing['color'] = '#506077';
            s_roads_casing['linejoin'] = 'round';
            s_roads_casing['width'] = 11;
            s_roads_casing['z-index'] = -1;
        }

        if (((type == 'way' && tags['highway'] == 'trunk_link' && (!tags.hasOwnProperty('tunnel?'))) && zoom === 12)) {
            s_roads_casing['color'] = '#477147';
            s_roads_casing['linejoin'] = 'round';
            s_roads_casing['width'] = 3;
            s_roads_casing['z-index'] = -1;
        }
        ...
        if (((type == 'way' && tags['highway'] == 'secondary_link' && (!tags.hasOwnProperty('tunnel?'))) && zoom === 12)) {
            s_roads_casing['color'] = '#a37b48';
            s_roads_casing['linecap'] = 'round';
            s_roads_casing['linejoin'] = 'round';
            s_roads_casing['width'] = 2.5;
            s_roads_casing['z-index'] = -1;
        }
        ...
        if (((type == 'way' && tags['highway'] == 'tertiary_link' && (!tags.hasOwnProperty('tunnel?'))) && zoom === 13)) {
            s_roads_casing['color'] = '#bbbbbb';
            s_roads_casing['linecap'] = 'round';
            s_roads_casing['linejoin'] = 'round';
            s_roads_casing['width'] = 6;
            s_roads_casing['z-index'] = -1;
        }
        ...
        if (((type == 'way' && tags['highway'] == 'pedestrian' && (!tags.hasOwnProperty('tunnel?'))) && zoom === 13)) {
            s_roads_casing['color'] = 'grey';
            s_roads_casing['linecap'] = 'round';
            s_roads_casing['linejoin'] = 'round';
            s_roads_casing['width'] = 2;
            s_roads_casing['z-index'] = -1;
        }
        ...
        if (((type == 'way' && tags['highway'] == 'living_street') && zoom >= 17)) {
            ...
            s_roads_casing['linecap'] = 'round';
            s_roads_casing['linejoin'] = 'round';
            s_roads_casing['width'] = 14.5;
            s_roads_casing['z-index'] = -1;
        }

        if (((selector == 'area' && tags['highway'] == 'living_street' && true) && zoom >= 14)) {
            s_default['fill-color'] = '#cccccc';
        }

        if (((selector == 'area' && tags['highway'] == 'residential' && true) && zoom >= 14) || ((selector == 'area' && tags['highway'] == 'unclassified' && true) && zoom >= 14) || ((selector == 'area' && tags['highway'] == 'service' && true) && zoom >= 14)) {
            s_default['fill-color'] = 'white';
        }

        if (((selector == 'area' && tags['highway'] == 'pedestrian' && true) && zoom >= 14) || ((selector == 'area' && tags['highway'] == 'footway' && true) && zoom >= 14) || ((selector == 'area' && tags['highway'] == 'path' && true) && zoom >= 14)) {
        ...
        if (((selector == 'area' && tags['aeroway'] == 'runway' && true) && zoom >= 11)) {
            s_default['fill-color'] = '#bbbbcc';
        }

        if (((selector == 'area' && tags['aeroway'] == 'taxiway' && true) && zoom >= 13)) {
            s_default['fill-color'] = '#bbbbcc';
        }

        if (((selector == 'area' && tags['aeroway'] == 'helipad' && true) && zoom >= 16)) {
            s_default['fill-color'] = '#bbbbcc';
        }
        ...
        if (((type == 'way' && tags['highway'] == 'motorway' && (tags.hasOwnProperty('bridge?'))) && zoom === 12) || ((type == 'way' && tags['highway'] == 'motorway' && tags['bridge'] == 'viaduct') && zoom === 12) || ((type == 'way' && tags['highway'] == 'motorway_link' && (tags.hasOwnProperty('bridge?'))) && zoom === 12) || ((type == 'way' && tags['highway'] == 'motorway_link' && tags['bridge'] == 'viaduct') && zoom === 12)) {
            s_bridge_casing1['color'] = '#506077';
            s_bridge_casing1['width'] = 3;
            s_bridge_casing1['z-index'] = 2;
        }
        ...
        if (((type == 'way' && tags['highway'] == 'motorway' && (tags.hasOwnProperty('bridge?'))) && zoom >= 13 && zoom <= 14) || ((type == 'way' && tags['highway'] == 'motorway' && tags['bridge'] == 'viaduct') && zoom >= 13 && zoom <= 14) || ((type == 'way' && tags['highway'] == 'motorway_link' && (tags.hasOwnProperty('bridge?'))) && zoom >= 13 && zoom <= 14) || ((type == 'way' && tags['highway'] == 'motorway_link' && tags['bridge'] == 'viaduct') && zoom >= 13 && zoom <= 14)) {
            s_bridge_casing1['color'] = 'black';
            s_bridge_casing1['width'] = 6.5;
            s_bridge_casing1['z-index'] = 2;
        }
        ...
        if (((type == 'way' && tags['highway'] == 'trunk' && (tags.hasOwnProperty('bridge?'))) && zoom === 12) || ((type == 'way' && tags['highway'] == 'trunk' && tags['bridge'] == 'viaduct') && zoom === 12) || ((type == 'way' && tags['highway'] == 'trunk_link' && (tags.hasOwnProperty('bridge?'))) && zoom === 12) || ((type == 'way' && tags['highway'] == 'trunk_link' && tags['bridge'] == 'viaduct') && zoom === 12)) {
            s_bridge_casing1['color'] = '#477147';
            s_bridge_casing1['width'] = 4;
            s_bridge_casing1['z-index'] = 2;
        }
        ...
        if (((type == 'way' && tags['railway'] == 'rail' && (tags.hasOwnProperty('bridge?'))) && zoom >= 13) || ((type == 'way' && tags['railway'] == 'rail' && tags['bridge'] == 'viaduct') && zoom >= 13)) {
            s_bridge_casing1['color'] = 'black';
            s_bridge_casing1['linejoin'] = 'round';
            s_bridge_casing1['width'] = 6.5;
            s_bridge_casing1['z-index'] = 2;
        }
        ...
        if (((type == 'way' && tags['railway'] == 'subway' && (tags.hasOwnProperty('bridge?'))) && zoom >= 14) || ((type == 'way' && tags['railway'] == 'subway' && tags['bridge'] == 'viaduct') && zoom >= 14)) {
            s_bridge_casing2['color'] = 'white';
            s_bridge_casing2['width'] = 4;
            s_bridge_casing2['z-index'] = 3;
        }
        ...
        if (((type == 'way' && tags['highway'] == 'unsurfaced' && (tags.hasOwnProperty('bridge?'))) && zoom === 13) || ((type == 'way' && tags['highway'] == 'unsurfaced' && tags['bridge'] == 'viaduct') && zoom === 13)) {
            s_bridge_casing2['color'] = 'white';
            s_bridge_casing2['linecap'] = 'round';
            s_bridge_casing2['linejoin'] = 'round';
            s_bridge_casing2['width'] = 4;
            s_bridge_casing2['z-index'] = 3;
        }
